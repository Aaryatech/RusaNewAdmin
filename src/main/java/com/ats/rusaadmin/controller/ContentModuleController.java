...
public class ContentModuleController {
	...
	public ModelAndView textimonialForm(@PathVariable int pageId,@PathVariable int moduleId,HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			page =  Constant.getRestTemplate().postForObject(Constant.url + "/getPageByPageId",map,
					 Page.class);
	...
	public String insertCmsForm(@RequestParam("images") List<MultipartFile> images ,HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			TestImonial res =  Constant.getRestTemplate().postForObject(Constant.url + "/saveTextImonial", editTestImonial, TestImonial.class);
	...
	public ModelAndView editTestImonial(@PathVariable int id, HttpServletRequest request,
		...
		try {
			...
			MultiValueMap<String, Object> map = new LinkedMultiValueMap<String, Object>();
			map.add("id", id); 
			editTestImonial =  Constant.getRestTemplate().postForObject(Constant.url + "/getTestImonialById", map, TestImonial.class);
	...
	public ModelAndView successStoryList(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			GetPagesModule[] getPagesModule =  Constant.getRestTemplate().getForObject(Constant.url + "/getSuccessStoryList",
	...
	public String deletesuccessStory(@PathVariable("id") int id, HttpServletRequest request, HttpServletResponse response) {
		...
		try {		 
			 MultiValueMap<String, Object> map = new LinkedMultiValueMap<String, Object>();
			 map.add("id", id);
			 Info info =  Constant.getRestTemplate().postForObject(Constant.url + "/deleteTestImonial",map,
					 Info.class);
	...
	public ModelAndView testImonialList(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			GetPagesModule[] getPagesModule =  Constant.getRestTemplate().getForObject(Constant.url + "/getTestImonialList",
					GetPagesModule[].class);
	...
	public ModelAndView NewsBlogForm(@PathVariable int pageId,HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			GetPagesModule[] getPagesModule =  Constant.getRestTemplate().postForObject(Constant.url + "/getNewsBlogsListByPageId",map,
					GetPagesModule[].class);
	...
	public String insertCmsForm(@RequestParam("images") List<MultipartFile> images,@RequestParam("pagePdf") List<MultipartFile> pagePdf
		...
		//	System.out.println(text);
			...
			NewsBlog res =  Constant.getRestTemplate().postForObject(Constant.url + "/saveNewsBlogHeaderAndDetail", newsBlog, NewsBlog.class);
	...
	public String submtEditNewsBlogForm(@RequestParam("images") List<MultipartFile> images,@RequestParam("pagePdf") List<MultipartFile> pagePdf
		...
		/*	int isEdit = Integer.parseInt(request.getParameter("isEdit"));
			...
			*/
			...
			NewsBlog res =  Constant.getRestTemplate().postForObject(Constant.url + "/saveNewsBlogHeaderAndDetail", editNewsBlog, NewsBlog.class);
	...
	public ModelAndView EventForm(@PathVariable int pageId,HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			GetPagesModule[] getPagesModule =  Constant.getRestTemplate().postForObject(Constant.url + "/getEventListByNewsblogsId",map,
					GetPagesModule[].class);
	...
	public String deleteVideoGallary(@PathVariable int galleryDetailsId, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			MultiValueMap<String, Object> map = new LinkedMultiValueMap<String, Object>();
			map.add("galleryDetailsId", galleryDetailsId); 
			Info res =  Constant.getRestTemplate().postForObject(Constant.url + "/deleteGalleryDetails", map, Info.class);
	...
	public String submitVedioForm(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			GallaryDetail res =  Constant.getRestTemplate().postForObject(Constant.url + "/saveGalleryDetails", editGalleryDetail, GallaryDetail.class);
			System.out.println("List : "+res.toString());
