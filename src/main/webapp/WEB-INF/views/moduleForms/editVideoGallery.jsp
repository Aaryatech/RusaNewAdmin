					...
					<section class="box ">
						...
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<a href="${pageContext.request.contextPath}/VedioFormList"><button
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/submitVedioForm"
										method="post">
										...
										<div class="tab-content">
													...
													<c:choose>
														...
														<c:otherwise>
															<input type="hidden" name="pageId"
																value="${editGalleryDetail.pageId}">
														</c:otherwise>
													</c:choose>
														...
														<div class="col-sm-10">
															<select id="cateId" name="cateId"
																...
																<c:forEach items="${categoryList}" var="catList">
																	<c:choose>
																		<c:when
																			test="${catList.galleryCatId==editGalleryDetail.galleryCatId}">
								        	...
								        	<option value="${catList.galleryCatId}">${catList.cateName}</option>
													...
													<div class="form-group">
														<label class="control-label col-sm-2" for="status">Title
                                ...
                                <label class="control-label col-sm-2" for="status">Video :<span class="text-danger">*</span></label>
                                 	 <div class="col-sm-10" >
										...
										<INPUT TYPE="radio" NAME="vedio_url" VALUE="1"  onclick="showhide(1)">Code<BR>
													...
													<INPUT TYPE="hidden" NAME="vedio_url" VALUE="1">
