...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Success Story List</h1><!-- PAGE HEADING TAG - END -->                            </div>
...
<div class="col-lg-12">
    <section class="box "> 
             <header class="panel_header">
                <h2 class="title pull-left">Success Story List</h2>
                <div class="actions panel_actions pull-right">
                 <a href="${pageContext.request.contextPath}/sectionTreeList"><button type="button" class="btn btn-success">Add Success Story</button></a>
            ...
            <br>
									<form
										action="${pageContext.request.contextPath}/multipleSuccessStoryDelete"
									...
									<tr  >
										...
										<td><a
											...
											onClick="singleDelete(${getPagesModuleList.primaryKeyId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
												...
												<!-- ${pageContext.request.contextPath}/deleteTestImonial/${getPagesModuleList.primaryKeyId} -->
									</tr>
								</c:forEach>  
                </tbody>
            </table>
...
<!-- LOAD FILES AT PAGE END FOR FASTER LOADING -->
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deletesuccessStory/"+id;
		//document.getElementById("multipleDelete").submit();
