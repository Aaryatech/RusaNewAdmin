...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">FAQ List</h1><!-- PAGE HEADING TAG - END -->                            </div>
									...
									<tr>
										...
										<td><a
											...
											onClick="singleDelete(${getPagesModuleList.primaryKeyId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
												class="glyphicon glyphicon-remove"></span></a></td><!-- ${pageContext.request.contextPath}/deleteFaqContent/${getPagesModuleList.primaryKeyId} -->
									</tr>
								</c:forEach>  
                </tbody>
            </table>
