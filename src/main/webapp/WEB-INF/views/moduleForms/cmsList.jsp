				...
				<div class='col-xs-12'>
					<div class="page-title">
						...
						<div class="pull-left">
							...
							<h1 class="title">CMS Pages List</h1>
                    ...
                    <a class="box_close fa fa-times"></a> -->
						...
						<div class="content-body">
							<div class="row">
								...
								<form
									action="${pageContext.request.contextPath}/multipleCMSDelete"
...
<input type="hidden" value="<%out.println(hashtext);%>"
												...
												<c:forEach items="${getPagesModuleList}"
													...
													<tr>
														...
														<td style="text-align: center;"><input
															...
															id="cms${getPagesModuleList.primaryKeyId}"
														...
														<!-- ${pageContext.request.contextPath}/deleteCmsContent/${getPagesModuleList.primaryKeyId} -->
													</tr>
												</c:forEach>
											</tbody>
										</table>
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteCmsContent/"+id+"/"+token;
		//document.getElementById("multipleDelete").submit();
