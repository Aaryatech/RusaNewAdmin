                ...
                <tbody>
                        <c:forEach items="${getPagesModuleList}" var="getPagesModuleList" varStatus="count">
									<tr  >
										...
										<td><a
											href="${pageContext.request.contextPath}/editSection/${getPagesModuleList.primaryKeyId}"><span
												class="glyphicon glyphicon-edit" data-animate=" animated fadeIn "
												rel="tooltip" ></span></a> | <a
											href="${pageContext.request.contextPath}/deleteSection/${getPagesModuleList.primaryKeyId}"
