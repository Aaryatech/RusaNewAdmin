...
<section id="main-content" class=" ">
    ...
    <div class="col-lg-12">
        <section class="box ">
                ...
                <div class="content-body"> 
                    <div class="row">
                    <div class="col-md-12">
                         <form class="form-horizontal" action="${pageContext.request.contextPath}/insertEventForm" method="post" enctype="multipart/form-data" name="form_sample_2" id="form_sample_2" 
                	...
                	<c:when test="${isEdit==0}">
                      ...
                      <div class="col-xs-12"> 
                    		 <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="event_loc" name="event_loc" placeholder="Event Location"  >
                                </div>
                              </div>
                        </div>
                         <div class="col-xs-12"> 
    ...
    <section class="box "> 
             <header class="panel_header">
                ...
                <div class="actions panel_actions pull-right">
                 <a href="${pageContext.request.contextPath}/sectionTreeList"><button type="button" class="btn btn-success">Add Event Content</button></a>
                	<a class="box_toggle fa fa-chevron-down"></a>
