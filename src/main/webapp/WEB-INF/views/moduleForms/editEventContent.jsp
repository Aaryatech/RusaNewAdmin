																				...
																				<div class="form-group">
																					...
																					<div class="col-sm-10">
																						<input type="text" class="form-control"
																							...
																							placeholder="Heading"
																							value="${detailList.heading}" required>
																					</div>
																				</div>
																				<div class="form-group">
																					<label class="control-label col-sm-2"
                                     ...
                                     ${detailList.pageMetaDescription}</textarea>
																...
																<div class="col-xs-12">
																	...
																	<div class="form-group row">
																		<label class="control-label col-sm-2"
																			for="category_id">Featured Image :</label>
																		<div class="col-sm-7">
																		...
																		<div class="col-sm-10">
																			...
																			<c:if test="${find3==0}">
																				<div class="form-check-label" for="check3">
																					<label class="form-check-label"> <input
																						type="checkbox" class="form-check-input"
																						id="check3" name="type" value="3">University
																					</label>
																				</div>
																		...
																		<div class="col-sm-7">
																			<c:choose>
																				<c:when test="${editNewsBlog.exInt2==1}">
																					<input type="radio" name="doc" id="doc" value="0" /> No
                                              <input type="radio"
																						name="doc" id="doc" value="1" checked> Yes
                                          	</c:when>
																				<c:otherwise>
																					<input type="radio" name="doc" id="doc" value="0"
																						checked> No
                                              <input type="radio"
