...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Video Gallery List</h1><!-- PAGE HEADING TAG - END -->                            </div>
                         ...
                         <c:forEach items="${gallaryDetailList}" var="gallaryDetailList" varStatus="count">
									<tr  >
										...
										<td>  <a href="editVideoContent/${gallaryDetailList.galleryDetailsId}" ><span
											...
											href="#"
											onClick="singleDelete(${gallaryDetailList.galleryDetailsId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
 ...
 <script type="text/javascript">
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteVideoGallery/"+id;
