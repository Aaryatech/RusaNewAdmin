	...
	<c:forEach items="${languagesList}" var="languagesList">
												...
												<div class="col-xs-12">
													<div class="form-group">
														<label class="control-label col-sm-2" for="page_name">Designation
															:</label>
														<div class="col-sm-10">
															<input type="text" class="form-control" id="designation${languagesList.languagesId}"
																name="designation${languagesList.languagesId}" placeholder="Designation" onchange="trim(this)"
												...
												<div class="col-xs-12">
													<div class="form-group">
														<label class="control-label col-sm-2" for="page_name">Location
															:</label>
														<div class="col-sm-10">
															<input type="text" class="form-control" id="location${languagesList.languagesId}" onchange="trim(this)"
																name="location${languagesList.languagesId}" placeholder="Location"
												...
												<c:choose>
													<c:when test="${moduleId==8}">
														...
														<input type="hidden" name="formType${languagesList.languagesId}" value="1">
															...
															<div class="form-group">
																...
																<div class="col-sm-10">
																	...
																	<textarea
																		...
																		name="message${languagesList.languagesId}"  onchange="trim(this)" id="message${languagesList.languagesId}">
														...
														<div class="col-xs-12" id="video1" style="display: none">
															<div class="form-group">
																...
																<div class="col-sm-10">
																	...
																	<textarea
																		style="width: 100%; height: 150px; font-size: 14px; line-height: 23px; padding: 15px;"
																		name="video${languagesList.languagesId}" id="video${languagesList.languagesId}">	
													...
													<c:when test="${moduleId==13}">
														...
														<input type="hidden" name="formType${languagesList.languagesId}" value="1">
														<input type="hidden" name="message${languagesList.languagesId}">
														<input type="hidden" name="video1${languagesList.languagesId}">
																	...
																	<label class="form-check-label"> <c:choose>
																			<c:when test="${editTestImonial.exInt1==1}">
																				<input type="radio" class="form-check-input"
																					name="formType${languagesList.languagesId}" value="1"
																...
																<div class="form-check-inline">
																	<label class="form-check-label"> <c:choose>
																			<c:when test="${editTestImonial.exInt1==2}">
																				<input type="radio" class="form-check-input"
																					name="formType${languagesList.languagesId}" id="formType${languagesList.languagesId}" value="2"
																					onclick="check(this.value)" checked>
																		Video
																		</c:when>
																			<c:otherwise>
																	...
																	<c:choose>
																		<c:when test="${editTestImonial.exInt1==2}">
																			...
																			<textarea rows="3" cols="3" class="form-control"
																				style="width: 100%; height: 150px; font-size: 14px; line-height: 23px; padding: 15px;"
																				name="message${languagesList.languagesId}" id="message${languagesList.languagesId}"></textarea>
																		</c:when>
																		<c:otherwise>
																			<textarea rows="3" cols="3" class="form-control"
																				style="width: 100%; height: 150px; font-size: 14px; line-height: 23px; padding: 15px;"
																				name="message${languagesList.languagesId}" id="message${languagesList.languagesId}">${editTestImonial.message}</textarea>
																		</c:otherwise>
																	</c:choose>
																...
																<div class="col-sm-10">
																	...
																	<c:choose>
																		<c:when test="${editTestImonial.exInt1==2}">
																			...
																			<textarea rows="3" cols="3" class="form-control"
																				style="width: 100%; height: 150px; font-size: 14px; line-height: 23px; padding: 15px;"
																				name="video${languagesList.languagesId}" id="video${languagesList.languagesId}">${editTestImonial.message}</textarea>
																		</c:when>
																		<c:otherwise>
																			<textarea rows="3" cols="3" class="form-control"
																				style="width: 100%; height: 150px; font-size: 14px; line-height: 23px; padding: 15px;"
																				name="video${languagesList.languagesId}" id="video${languagesList.languagesId}"></textarea>
																		</c:otherwise>
																	</c:choose>
