...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">News List</h1><!-- PAGE HEADING TAG - END -->                            </div>
...
<div class="col-lg-12">
    <section class="box "> 
            ...
            <br>
									<form
										action="${pageContext.request.contextPath}/multipleNewsListDelete"
									...
									<tr  >
										...
										<td><a
											...
											onClick="singleDelete(${getPagesModuleList.primaryKeyId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
												...
												<!-- ${pageContext.request.contextPath}/deleteNewsBlogContent/${getPagesModuleList.primaryKeyId} -->
									</tr>
								</c:forEach>  
                </tbody>
            </table>
 ...
 $(document).ready(function($) {
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteNewsBlogContent/"+id;
		//document.getElementById("multipleDelete").submit();
