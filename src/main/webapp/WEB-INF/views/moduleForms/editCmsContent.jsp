				...
				<div class="col-xs-12">
					<div class="page-title">
						...
						<div class="pull-left">
							...
							<h1 class="title">Edit CMS Form</h1>
							...
							<div class="row">
								<div class="col-md-12">
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/submtEditCmsForm"
											...
											<div class="tab-pane fade in active" id="home">
												...
												<div>
													...
													<c:forEach items="${languagesList}" var="languagesList">
														<c:forEach items="${editCMSPages.detailList}"
															var="detailList">
														...
														<div class="form-group">
															...
															<div class="col-sm-10">
																<select id="header_top_alignment"
																	...
																	<c:choose>
																		<c:when
																			test="${editCMSPages.featuredImageAlignment eq 'none'}">
																		...
																		<c:when
																			test="${editCMSPages.featuredImageAlignment eq 'center'}">
																		...
																		<c:when
																			test="${editCMSPages.featuredImageAlignment eq 'left'}">
																			<option value="none">None</option>
																			<option value="center">Center</option>
																		...
																		<c:when
																			test="${editCMSPages.featuredImageAlignment eq 'right'}">
																			<option value="none">None</option>
																			<option value="center">Center</option>
																			<option value="left">Left</option>
