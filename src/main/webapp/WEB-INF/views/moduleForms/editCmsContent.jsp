    ...
    <div class="col-lg-12">
        <section class="box ">
                ...
                <div class="content-body"> 
                    <div class="row">
                    <div class="col-md-12">
                         <form class="form-horizontal" action="${pageContext.request.contextPath}/submtEditCmsForm" method="post" enctype="multipart/form-data" name="form_sample_2" id="form_sample_2" 
                    ...
                    <div class="tab-content">
                      ...
                      <c:forEach items="${languagesList}" var="languagesList" >
                      	<c:forEach items="${editCMSPages.detailList}" var="detailList" >
                       ...
                       <div class="col-xs-12"> 
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="smallheading${detailList.languageId}" name="smallheading${detailList.languageId}" placeholder="Small heading" value="${detailList.smallheading}" >
                                </div>
                              </div>
                        ...
                        <hr>
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="page_order" name="page_order" placeholder="Sort Order" value="${editCMSPages.pageOrder}" required>
                                </div>
                              </div>
                                 
                               <c:if test="${editCMSPages.featuredImage!=null}">
                               	<div class="form-group">  
                                 <label class="col-md-2 control-label">Current Image</label>
                                          <div class="col-md-10">
                                                  <img src="${url}${editCMSPages.featuredImage}" style="width:150px; height:auto">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="form-group">
                                ...
                                <c:choose>
                                <c:when test="${editCMSPages.featuredImageAlignment eq 'none'}">
                                	<option value="none"  selected>None</option>
                                    <option value="center"  >Center</option>
                    				<option value="left"  >Left</option>
                                    <option value="right" >Right</option>
                                </c:when>
                                 <c:when test="${editCMSPages.featuredImageAlignment eq 'center'}">
                                	<option value="none"  >None</option>
                                    <option value="center" selected>Center</option>
                    				<option value="left"  >Left</option>
                                    <option value="right" >Right</option>
                                </c:when>
                                 <c:when test="${editCMSPages.featuredImageAlignment eq 'left'}">
                                	<option value="none"  >None</option>
                                    <option value="center"  >Center</option>
                    				<option value="left"  selected>Left</option>
                                    <option value="right" >Right</option>
                                </c:when>
                                 <c:when test="${editCMSPages.featuredImageAlignment eq 'right'}">
                                	<option value="none"   >None</option>
                                    <option value="center"  >Center</option>
                    				<option value="left"  >Left</option>
                    ...
                    <div class="col-sm-10">
							<a href="${url}${editCMSPages.downloadPdf}" target="_blank">${editCMSPages.downloadPdf} <%-- - ${documentUploadList.fileSize} --%></a>
						</div>
						</div>
						</c:if>
 										 <div class="form-group row">
                                ...
                                <div class="form-group row">
                                         <label class="control-label col-sm-2" for="page_pdf">On Home Page :</label>
                                          <div class="col-sm-7">
                                          <c:choose>
                                          	<c:when test="${editCMSPages.detailList[0].exInt1==1}">
                               ...
                               <div class="form-group">
                                ...
                                <c:choose>
                                	<c:when test="${editCMSPages.isActive==0}">
