                        ...
                        <c:forEach items="${imagesLinkList}" var="imagesLinkList" varStatus="count">
									<tr  >
										...
										<td><a
											...
											href="#"
											onClick="singleDelete(${imagesLinkList.id});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
 ...
 <script type="text/javascript">
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteImageLink/"+id;
