									...
									<div class="col-xs-12">
										...
										<div class="form-group">
											<label class="control-label col-sm-2"
												for="config_maintenance">Site Maintenance Status: </label>
											<div class="col-sm-10">
										...
										<div class="form-group">
											<label class="control-label col-sm-2"
												for="config_site_maintenance_message">Message: </label>
											<div class="col-sm-10">
												<input id="message" class="form-control"
													onchange="trim(this)" placeholder="Message"
													style="text-align: left;" name="message" type="text"
													value="${editsiteMain.message}">
											</div>
										</div>
