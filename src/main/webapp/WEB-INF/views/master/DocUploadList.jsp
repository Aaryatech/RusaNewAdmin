...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Document List</h1><!-- PAGE HEADING TAG - END -->                            </div>
...
<div class="col-lg-12">
    <section class="box "> 
             <header class="panel_header">
                <h2 class="title pull-left"> Document List</h2>
                <div class="actions panel_actions pull-right">
                 <a href="${pageContext.request.contextPath}/sectionTreeList"><button type="button" class="btn btn-success">Add Document</button></a>
                        ...
                        <c:forEach items="${docList}" var="getDocList" varStatus="count">
									<tr  >
										...
										<td><a
											...
											rel="tooltip" ></span></a> |
										    <a href="#"
											onClick="singleDelete(${getDocList.docId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
											class="glyphicon glyphicon-remove"></span></a></td>
											<!-- ${pageContext.request.contextPath}/deleteDocument/${getDocList.docId} -->
									</tr>
								</c:forEach>  
                </tbody>
            </table>
