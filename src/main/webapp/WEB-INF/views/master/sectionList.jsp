...
<body class=" " onload="clearSessionAttribute()">
												...
												<tr>
													...
													<td><a
														href="${pageContext.request.contextPath}/editSection/${sectionList.sectionId}"><span
															...
															test="${sectionList.exInt3==0}">
												| <a href="#"
																onClick="singleDelete(${sectionList.sectionId});"
																rel="tooltip" data-color-class="danger"
																data-animate=" animated fadeIn " data-toggle="tooltip"
																data-original-title="Delete  record"><span
																class="glyphicon glyphicon-remove"></span></a>
															<!-- ${pageContext.request.contextPath}/deleteSection/${sectionList.sectionId} -->
														</c:if></td>
												</tr>
											</c:forEach>
										</tbody>
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteSection/"+id+"/"+token;
