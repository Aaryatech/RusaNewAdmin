							...
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<table id="example-11"
										...
										<tbody>
											<c:forEach items="${list.sectionlist}" var="sectionlist"
												varStatus="count">
												<tr>
													<td>${count.index+1}</td>
													<td>${sectionlist.sectionName}</td>
													<td><a href="#myModal" data-toggle="modal"
														onclick="getPageId(${sectionlist.pageId})"><button
																type="button" class="btn btn-info">Add Content</button></a></td>
												</tr>
												...
												<c:forEach items="${list.categoryList}" var="categoryList">
													<c:if test="${categoryList.sectionId==sectionlist.sectionId}">
														...
														<tr>
															<td></td>
															<td><span style="padding-right: 20px;"></span>-${categoryList.catName}</td>
															<td><a href="#myModal" data-toggle="modal"
																onclick="getPageId(${categoryList.pageId})"><button
