...
<body class=" " onload="clearSessionAttribute()">
				...
				<div class='col-xs-12'>
					<div class="page-title">
						...
						<div class="pull-left">
							...
							<h1 class="title">Sub-Menu List</h1>
					...
					<section class="box ">
						<header class="panel_header">
							...
							<div class="actions panel_actions pull-right">
								<a href="${pageContext.request.contextPath}/addSubCategory"><button
										type="button" class="btn btn-success">Add Sub-Menu</button></a> <a
							...
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<table id="example-1"
										...
										<tbody>
											<c:forEach items="${subCategoryList}" var="categoryList"
												varStatus="count">
												<tr>
													<td>${count.index+1}</td>
													...
													<!-- ${pageContext.request.contextPath}/deleteSubCategory/${categoryList.catId} -->
												</tr>
											</c:forEach>
										</tbody>
									</table>
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteSubCategory/"+id+"/"+token;
