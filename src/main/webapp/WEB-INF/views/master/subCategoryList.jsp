...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Sub-Menu List</h1><!-- PAGE HEADING TAG - END -->                            </div>
...
<div class="col-lg-12">
    <section class="box "> 
             <header class="panel_header">
                <h2 class="title pull-left">Sub-Menu List</h2>
                <div class="actions panel_actions pull-right">
                 <a href="${pageContext.request.contextPath}/addSubCategory"><button type="button" class="btn btn-success">Add Sub-Menu</button></a>
        ...
        <div class="col-xs-12">
            ...
            <table id="example-1" class="table table-striped dt-responsive display">
                ...
                <tbody>
                        <c:forEach items="${subCategoryList}" var="categoryList" varStatus="count">
									<tr  >
										<td>${count.index+1}</td>
										...
										<td><a
											...
											onClick="singleDelete(${categoryList.catId});" rel="tooltip" data-color-class = "danger" data-animate=" animated fadeIn " data-toggle="tooltip" data-original-title="Delete  record"><span
												class="glyphicon glyphicon-remove"></span></a></c:if></td><!-- ${pageContext.request.contextPath}/deleteSubCategory/${categoryList.catId} -->
									</tr>
								</c:forEach>  
                </tbody>
            </table>
...
<!-- LOAD FILES AT PAGE END FOR FASTER LOADING -->
   ...
   function singleDelete(id) {
	...
	function submitFormSingle() {
		 ...
		 location.href = "${pageContext.request.contextPath}/deleteSubCategory/"+id;
