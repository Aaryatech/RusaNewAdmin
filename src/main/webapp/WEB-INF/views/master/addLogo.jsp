                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                                        ...
                                                        <div class="input-group image-preview1" data-original-title="" title="">
                                                            ...
                                                            <span class="input-group-btn">
                                                                ...
                                                                <div class="btn btn-default image-preview-input">
                                                                    ...
                                                                    <input type="file" accept="image/png, image/jpeg, image/gif" class="browseimage browseimage1" id="1" name="mainLogo"> <!-- rename it -->
                                                                </div>
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="row col-md-5">
                                                        <img src="" id="temppreviewimageki2" class="temppreviewimageki2" style="width:200px; height:auto;display:none">								 
                                                    </div>
                                                    <div class="row col-md-10">
                                                        <div class="input-group image-preview2" data-original-title="" title="">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <!-- image-preview-clear button -->
                                                                <button type="button" class="btn btn-default image-preview-clear image-preview-clear2" id="2" style="display:none;">
                                                                <span class="glyphicon glyphicon-remove"></span> Clear
                                                                </button>
                                                                <!-- image-preview-input -->
                                                                <div class="btn btn-default image-preview-input">
                                                                    ...
                                                                    <input type="file" accept="image/png, image/jpeg, image/gif" class="browseimage browseimage2" id="2" name="Logo2"> <!-- rename it -->
                                                                </div>
                                                            </span>
                                                        </div>
                                                        <span class="help-block">* Only jpg,gif,png</span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <img src="${url}${logo.logo3}" style="width:150px; height:auto">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="row col-md-5">
                                                        <img src="" id="temppreviewimageki3" class="temppreviewimageki3" style="width:200px; height:auto;display:none">								 
                                                    </div>
                                                    <div class="row col-md-10">
                                                        <div class="input-group image-preview3" data-original-title="" title="">
                                                            ...
                                                            <span class="input-group-btn">
                                                                <!-- image-preview-clear button -->
                                                                <button type="button" class="btn btn-default image-preview-clear image-preview-clear3" id="3" style="display:none;">
                                                                <span class="glyphicon glyphicon-remove"></span> Clear
                                                                </button>
                                                                <!-- image-preview-input -->
                                                                <div class="btn btn-default image-preview-input">
                                                                    ...
                                                                    <input type="file" accept="image/png, image/jpeg, image/gif" class="browseimage browseimage3" id="3" name="Logo3"> <!-- rename it -->
                                                                </div>
                                                            </span>
                                                        </div>
                                                        <span class="help-block">* Only jpg,gif,png</span>
