				...
				<div class="col-xs-12">
					<div class="page-title">
						...
						<div class="pull-left">
							...
							<h1 class="title">Other GOV Links</h1>
					...
					<section class="box ">
						...
						<header class="panel_header">
							<h2 class="title pull-left">
								<c:choose>
									<c:when test="${isEdit==1}">Edit Other GOV Links</c:when>
									<c:otherwise>Other GOV Links</c:otherwise>
								</c:choose>
							</h2>

							<div class="actions panel_actions pull-right">
								<a href="${pageContext.request.contextPath}/imageLinkList"><button
						...
						<form class="form-horizontal" id="addSupplier"
							action="${pageContext.request.contextPath}/insertImageLink"
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input id="title_name" class="form-control"
													onchange="trim(this)" placeholder="Title"
													value="${editImageLink.titleName}"
													style="text-align: left;" name="title_name" type="text"
													required>
											</div>
										</div>

										<input id="id" value="${editImageLink.id}" name="id"
											type="hidden">
										<c:choose>
											<c:when test="${isEdit==1}">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<img src="${url}${editImageLink.sliderImage}"
															style="width: 250px; height: auto"> <input
															id="imageName" value="${editImageLink.sliderImage}"
																...
																<span class="input-group-btn"> <!-- image-preview-clear button -->
																	...
																	<div class="btn btn-default image-preview-input">
																		...
																		<input type="file"
																			accept="image/png, image/jpeg, image/gif"
																			class="browseimage1" id="1" name="docfile"
																			value="${editImageLink.sliderImage}" required>
																		<!-- rename it -->
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input id="urlLink" class="form-control"
													...
													value="${editImageLink.urlLink}" style="text-align: left;"
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input id="sortNo" class="form-control"
													onchange="trim(this)" placeholder="Sequence No"
													value="${editImageLink.sortOrder}"
