...
<section id="main-content" class=" ">
    ...
    <div class='col-xs-12'>
        <div class="page-title">
            ...
            <div class="pull-left">
                <!-- PAGE HEADING TAG - START --><h1 class="title">Social Channel List</h1><!-- PAGE HEADING TAG - END -->                            </div>
										...
										<%-- <td><a
											href="${pageContext.request.contextPath}/editChannel/${channelList.id}"><span
												...
												rel="tooltip" ></span></a> 
      										 	...
      										 	<a href="${pageContext.request.contextPath}/deleteChannel/${channelList.id}"
